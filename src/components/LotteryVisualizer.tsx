...
export default function LotteryVisualizer() {
  ...
  return (
    <div className="w-full bg-dark-850 rounded-2xl border border-dark-700 p-6 sm:p-8 shadow-premium-card">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-dark-700/80">
        <div>
          ...
          <h3 className="text-xl sm:text-2xl font-heading font-black text-foreground uppercase tracking-tight">
        ...
        {/* Tab switch */}
        <div className="flex bg-dark-900 p-1 rounded-xl border border-dark-750 self-start sm:self-auto">
          <button
      ...
      {activeTab === "exemplo" ? (
        ...
        <div className="pt-6 space-y-6">
          ...
          <div className="space-y-3">
            {/* 1º Prêmio */}
            <div className="p-4 rounded-xl bg-dark-900 border border-dark-750/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 text-xs bg-red-500/10 text-red-400 border border-red-500/20 px-3 py-1.5 rounded-lg w-fit font-bold uppercase tracking-wider">
            ...
            {/* 3º Prêmio - Ganhador */}
            <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-500/15 via-dark-900 to-dark-900 border-2 border-emerald-500/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-glow-emerald">
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 text-xs bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 px-3.5 py-2 rounded-lg font-bold w-fit uppercase tracking-wider">
        ...
        <div className="pt-6 space-y-6">
          <div className="p-5 rounded-xl bg-dark-900 border border-dark-750">
            ...
            <div className="mt-4 p-4 rounded-xl bg-dark-950 border border-dark-700/60 flex items-center justify-center gap-4 text-center">
              <div>
