...
export default function TransparencyCard({
  ...
  return (
    <div className="w-full bg-dark-850 rounded-2xl border border-dark-700 p-6 sm:p-8 shadow-premium-card">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-dark-700/80">
        <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 my-6">
        <div className="p-4 rounded-xl bg-dark-900 border border-dark-750">
          ...
          <p className="text-2xl sm:text-3xl font-heading font-black text-foreground mt-1">
        ...
        <div className="p-4 rounded-xl bg-dark-900 border border-dark-750">
          ...
          <p className="text-2xl sm:text-3xl font-heading font-black text-emerald-400 mt-1">
        ...
        <div className="p-4 rounded-xl bg-dark-900 border border-dark-750">
          ...
          <p className="text-2xl sm:text-3xl font-heading font-black text-slate-200 mt-1">
      ...
      {/* Info note */}
      <div className="mt-6 p-3.5 rounded-xl bg-dark-900 border border-dark-750 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-slate-400">
