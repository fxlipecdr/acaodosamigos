...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-900 border-t border-dark-750 text-slate-400 text-sm mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/numeros" className="hover:text-primary-400 transition-colors flex items-center gap-1.5 font-medium">
                  <ChevronRight className="w-3.5 h-3.5 text-primary-500 shrink-0" />
                  <span>ESCOLHER NÚMEROS ONLINE</span>
                </Link>
              </li>
              <li>
                <Link href="/pontos-de-venda" className="hover:text-primary-400 transition-colors flex items-center gap-1.5 font-medium">
                  <ChevronRight className="w-3.5 h-3.5 text-primary-500 shrink-0" />
                  <span>ONDE COMPRAR PRESENCIALMENTE</span>
                </Link>
              </li>
              <li>
                <Link href="/meus-numeros" className="hover:text-primary-400 transition-colors flex items-center gap-1.5 font-medium">
                  <ChevronRight className="w-3.5 h-3.5 text-primary-500 shrink-0" />
                  <span>CONSULTAR MEUS NÚMEROS (CPF)</span>
                </Link>
              </li>
              <li>
                <Link href="/regras" className="hover:text-primary-400 transition-colors flex items-center gap-1.5 font-medium">
                  <ChevronRight className="w-3.5 h-3.5 text-primary-500 shrink-0" />
                  <span>REGULAMENTO DA AÇÃO</span>
                </Link>
              </li>
              <li>
                <Link href="/resultado" className="hover:text-primary-400 transition-colors flex items-center gap-1.5 font-medium">
                  <ChevronRight className="w-3.5 h-3.5 text-primary-500 shrink-0" />
          ...
          <div className="space-y-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-xs font-bold uppercase tracking-wider transition-all"
            >
        ...
        <div className="pt-8 border-t border-dark-800 text-center text-xs text-slate-400 space-y-2">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-[11px] text-slate-400 pt-2 font-bold uppercase">
            <Link href="/termos" className="hover:text-foreground">TERMOS DE PARTICIPAÇÃO</Link>
            <span>•</span>
            <Link href="/privacidade" className="hover:text-foreground">POLÍTICA DE PRIVACIDADE</Link>
            <span>•</span>
            <Link href="/admin/login" className="hover:text-primary-400">ACESSO ADMINISTRATIVO</Link>
          </div>
